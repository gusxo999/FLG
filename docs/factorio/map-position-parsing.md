...
[factorio/parseGameData.ts](../../src/factorio/parseGameData.ts):
...
[pixi/pixi-manager.ts](../../src/UI/pixi/pixi-manager.ts):
...
[components/EntityDetails.tsx](../../src/UI/components/EntityDetails.tsx):
...
| [2] 파서 정규화 | [factorio/parseGameData.ts](../../src/factorio/parseGameData.ts) | `normalizeVec2()`, `normalizeCollisionBox()`, `parseFluidBoxes()` |
| [3] 렌더링 가드 | [pixi/pixi-manager.ts](../../src/UI/pixi/pixi-manager.ts) | `isValidVec()` |
| [3] 렌더링 가드 | [components/EntityDetails.tsx](../../src/UI/components/EntityDetails.tsx) | inline `typeof x === 'number'` |
