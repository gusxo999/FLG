...
- [src/autoLayout/tree/types/recipe.ts](../../src/autoLayout/tree/types/recipe.ts) — 위저드 입출력 타입
- [src/autoLayout/tree/arith/recipe.ts](../../src/autoLayout/tree/arith/recipe.ts) — 1단계 (재료 트리 + 카운트)
