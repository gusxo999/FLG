...
| 머신 좌표 결정·commit | 좌표 [layeredWizard.ts](../../../src/autoLayout/layeredWizard.ts), footprint commit `commitContainer` ([machinePlacer.ts](../../../src/autoLayout/shared/cells/place.ts)) |
