...
| 트랙 내 벨트/투입기/파이프 깔기 | 옛 `routeWithFallback` → `routePorts`(2026-09-16 삭제 → [manual-edit](../../deferred/manual-edit.md)) / `commitRouting` ([execution/emitPath.ts](../../../src/autoLayout/execution/emitPath.ts)) |
