        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
          ...
          {step === 'inserter' && (
            <>
              <CheckboxStep
                ...
                onToggle={(name) => toggle(selectedInserters, name, setSelectedInserters)}
                t={t}
              />
          ...
          {step === 'belt' && (
            <>
              <CheckboxStep
                ...
                onToggle={(name) => toggle(selectedBelts, name, setSelectedBelts)}
                t={t}
              />
              {undergroundBeltCandidates.length > 0 && (
                <CheckboxStep
                  ...
                  onToggle={(name) =>
                    toggle(selectedUndergroundBelts, name, setSelectedUndergroundBelts)
                  }
                  t={t}
                />
              )}
          ...
          {step === 'pipe' && (
            <CheckboxStep
              ...
              onToggle={(name) => toggle(selectedPipes, name, setSelectedPipes)}
              t={t}
            />
          )}
